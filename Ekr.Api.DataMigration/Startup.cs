using Ekr.Api.DataMigration.Middleware;
...
namespace Ekr.Api.DataMigration
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1.2.0", new OpenApiInfo { Title = "Ekr.Api.DataMigration", Version = "v1.2.0" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("v1.2.0/swagger.json", "Ekr.Api.DataMigration v1.2.0"));
            }
