using Ekr.Api.DataMatching.Middleware;
...
namespace Ekr.Api.DataMatching
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1.2.0", new OpenApiInfo { Title = "Ekr.Api.DataMatching", Version = "v1.2.0" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            if (bool.Parse(Configuration.GetSection("IsSwaggerVisible").Value))
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("v1.2.0/swagger.json", "Ekr.Api.DataMatching v1.2.0");
                    c.SwaggerEndpoint("DataMatching/swagger/v1.0.0/swagger.json", "Ekr.Api.DataMatching v1.2.0");
                }
                );
            }
