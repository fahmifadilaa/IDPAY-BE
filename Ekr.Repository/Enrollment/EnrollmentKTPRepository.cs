...
namespace Ekr.Repository.Enrollment
{
    public class EnrollmentKTPRepository : BaseRepository, IEnrollmentKTPRepository
    {
        private readonly IBaseConnection _baseConnection;
        private readonly ISysParameterRepository _sysParameterRepository;
        private readonly ILogger<EnrollmentKTPRepository> _logger;
        private readonly IConfiguration _config;

        public EnrollmentKTPRepository(IEKtpReaderBackendDb con,
            ...
            ILogger<EnrollmentKTPRepository> logger,
        ...
        {
            #region modified multi db connection
            //_baseConnection.WithConnection(c =>
            //{
            ...
            List<Tbl_DataKTP_Finger> exFinger, List<Tbl_DataKTP_Finger_Employee> exFingerEmployee, Tbl_MasterAlatReaderLog readerLog, Tbl_Mapping_Pegawai_KTP dataMapping)
        {
            try
            {
                ...
                #region update with multiple connection
                ...
                Db.WithTransaction(c =>
                {
                    ...
                    {
                        _ = InsertPhotoCamLog(photoCam_Log);
                        _ = DeletePhotoCam(exPhotoCam);
                    }
                    if (photoCam?.Nik != null) 
                    {
                        _ = InsertPhotoCam(photoCam); 
                    }
                    if (finger_Log.Count != 0)
                    {
                        foreach (var f in finger_Log)
                    ...
                    if (finger_Employee_Log.Count != 0)
                    {
                        ...
                        foreach (var e in exFingerEmployee)
                        {
                            if (e != null && e.Nik != null) _ = DeleteFingerEmployee(e);
                        }
                    }
                    if (finger_Employee.Count != 0)
                    {
        ...
        public async Task<(bool status, string msg)> InsertEnrollFlow3(Tbl_DataKTP_Demografis demografis, Tbl_DataKTP_Demografis_Log demografis_Log,
            Tbl_DataKTP_Photo photo,
            Tbl_DataKTP_Photo_Log photo_Log, Tbl_DataKTP_Signature signature,
            Tbl_DataKTP_Signature_Log signature_Log, Tbl_DataKTP_PhotoCam photoCam,
            Tbl_DataKTP_PhotoCam_Log photoCam_Log, List<Tbl_DataKTP_Finger> finger, List<Tbl_DataKTP_Finger_Log> finger_Log,
        ...
        public async Task<(bool status, string msg)> InsertEnrollFlow4(Tbl_DataKTP_Demografis demografis, Tbl_DataKTP_Demografis_Log demografis_Log,
            Tbl_DataKTP_Photo photo,
            Tbl_DataKTP_Photo_Log photo_Log, Tbl_DataKTP_Signature signature,
            Tbl_DataKTP_Signature_Log signature_Log, Tbl_DataKTP_PhotoCam photoCam,
            Tbl_DataKTP_PhotoCam_Log photoCam_Log, List<Tbl_DataKTP_Finger> finger, List<Tbl_DataKTP_Finger_Log> finger_Log,
        ...
        public long InsertKtpFingerLog(Tbl_DataKTP_Finger_Log log)
        {
            ...
            return _baseConnection.WithConnection(c => c.Insert(log, true));
        }
        ...
        {
            const string proc = "[ProcMonitoringEnrollData]";
            ...
            const string procCount = "[ProcMonitoringEnrollTotal]";
        ...
        public async Task<IEnumerable<ExportMonitoringEnrollTest>> ExportDBEnroll(ExportDataEnrollTempFilter filter)
        {
            const string proc = "[ProcExportMonitoringEnrollData]";
            //const string proc = "[ProcDasboardMonitoringEnrollData]";
            //const string proc = "[ProcDasboardMonitoringEnrollDataExcel]";
            ...
            //var res = await Db.WithConnectionAsync(c => c.QueryAsync<ExportMonitoringEnroll>(proc, val, commandType: CommandType.StoredProcedure, commandTimeout: 30000))
            //    .ConfigureAwait(false);

            var res = await Db.WithConnectionAsync(c => c.QueryAsync<ExportMonitoringEnrollTest>(proc, val, commandType: CommandType.StoredProcedure, commandTimeout: 12000))
               .ConfigureAwait(false);

            return res;
        }

        public async Task<IEnumerable<ExportMonitoringEnrollNew>> ExportDBEnrollNew(ExportDataEnrollTempFilter filter)
        {
            const string proc = "[ProcExportMonitoringEnrollData]";
            ...
            var res = await Db.WithConnectionAsync(c => c.QueryAsync<ExportMonitoringEnrollNew>(proc, val, commandType: CommandType.StoredProcedure, commandTimeout: 12000))
               .ConfigureAwait(false);

            return res;
        }

        public async Task<IEnumerable<ExportMonitoringEnrollNew>> ExportDBEnrollNew2(ExportDataEnrollTempFilterV5 filter)
        {
            const string proc = "[ProcExportMonitoringEnrollData]";
        ...
        public async Task<IEnumerable<ExportMonitoringEnroll>> ExportDBEnrollFR(ExportDataEnrollTempFilter filter)
        {
            ...
            var res = await Db.WithConnectionAsync(c => c.QueryAsync<ExportMonitoringEnroll>(proc, val, commandType: CommandType.StoredProcedure))
                .ConfigureAwait(false);

            return res;
        }

        #region old fix dashboard 20240325
        //public async Task<GridResponse<MonitoringEnroll>> GetDBEnrollV2(DataEnrollTempFilterV2 filter)
        //{
        //    //const string proc = "[ProcExportMonitoringEnrollDataV2]";
        //    const string proc = "[ProcDasboardMonitoringEnrollData]";
        ...
        public async Task<GridResponse<MonitoringEnroll>> GetDBEnrollV2(DataEnrollTempFilterV2 filter)
        {
            ...
            var res = await Db.WithConnectionAsync(c => c.QueryAsync<MonitoringEnroll>(proc, val, commandType: CommandType.StoredProcedure, commandTimeout: 6000))
                .ConfigureAwait(false);

            var resCount = await Db.WithConnectionAsync(c => c.QueryAsync<MonitoringEnrollCount>(proc, valCount, commandType: CommandType.StoredProcedure, commandTimeout: 6000))
                .ConfigureAwait(false);

            return new GridResponse<MonitoringEnroll>
            {
                Count = resCount.First().Total,
                Data = res
            };
        }
        #endregion
        ...
        #region
        //public async Task<GridResponse<MonitoringEnrollNew>> GetDBEnrollV3(DataEnrollTempFilterV2 filter)
        //{
        //    //const string proc = "[ProcExportMonitoringEnrollDataV2]";
        //    const string proc = "[ProcDasboardMonitoringEnrollData]";
        //    //const string proc = "[ProcExportMonitoringEnrollData]";
        ...
        //    var res = await Db.WithConnectionAsync(c => c.QueryAsync<MonitoringEnrollNew>(proc, val, commandType: CommandType.StoredProcedure, commandTimeout: 12000))
        //        .ConfigureAwait(false);

        //    var resCount = await Db.WithConnectionAsync(c => c.QueryAsync<MonitoringEnrollCount>(proc, valCount, commandType: CommandType.StoredProcedure, commandTimeout: 12000))
        //        .ConfigureAwait(false);


        //    //int resCount = await Db.WithConnectionAsync(c => c.QueryAsync<MonitoringEnrollCount>(proc, valCount, commandType: CommandType.StoredProcedure, commandTimeout: 6000))
        //    //    .ConfigureAwait(false);

        //    return new GridResponse<MonitoringEnrollNew>
        //    {
        //        Count = resCount.Count(),
        //        //Count = resCount.count(),
        //        Data = res
        ...
        //public async Task<GridResponse<MonitoringEnrollNew>> GetDBEnrollV3(DataEnrollTempFilterV4 filter)
        public async Task<GridResponseNew<MonitoringEnrollNew>> GetDBEnrollV4(DataEnrollTempFilterV4 filter)
        {
            //const string proc = "[ProcExportMonitoringEnrollDataV2]";
            const string proc = "[ProcDasboardMonitoringEnrollData]";
            //const string proc = "[ProcExportMonitoringEnrollData]";
            ...
            var res = await Db.WithConnectionAsync(c => c.QueryAsync<MonitoringEnrollNew>(proc, val, commandType: CommandType.StoredProcedure, commandTimeout: 2000000))
                .ConfigureAwait(false);

            var resCount = await Db.WithConnectionAsync(c => c.QueryAsync<MonitoringEnrollCount>(proc, valCount, commandType: CommandType.StoredProcedure, commandTimeout: 2000000))
                .ConfigureAwait(false);

            var resPagination = await Db.WithConnectionAsync(c => c.QueryAsync<MonitoringEnrollCount>(proc, valPagination, commandType: CommandType.StoredProcedure, commandTimeout: 2000000))
                .ConfigureAwait(false);
            ...
            //return new GridResponse<MonitoringEnrollNew>
            //{
            //    Count = resCount.Select(x => x.Total).FirstOrDefault(),
            //    //Count = res.Count(),
            //    Data = res
            //};

            return new GridResponseNew<MonitoringEnrollNew>
            {
                //Count = resCount.Count(),
                CountTotal = resCount.Select(x => x.Total).FirstOrDefault(),
                Count = resPagination.Count(),
                Data = res
            };
        }
        ...
        public async Task<string> GetNikByCif(string cif)
        {
            const string query = "select nik from Tbl_DataKTP_Demografis where cif = @cif";

            return await Db.WithConnectionAsync(c => c.QueryFirstOrDefaultAsync<string>(query, new { cif }));
        }
        ...
        public Task<Tbl_DataNIK_Pegawai> MappingNppNik(string npp)
        {
            ...
            const string query = "SELECT Top(1) t.NIK " +
                "FROM ( " +
                "SELECT [table] = 1, nik " +
                "FROM Tbl_MappingNIK_Pegawai " +
                "where Npp = @npp " +
                "UNION ALL " +
                "SELECT [table] = 2, nik " +
                "FROM Tbl_Mapping_Pegawai_KTP " +
                "where Npp = @npp " +
                ") t";
        ...
        public async Task<Tbl_DataKTP_Demografis> InsertDemografi(Tbl_DataKTP_Demografis req)
        {
            ...
            "values(" +
                ...
                _logger.LogError("[ErrorEnrollmentKTPRepository] : InsertDemografi : " + ex.Message, ex);
            }
        ...
        public async Task<Tbl_DataKTP_Demografis> UpdateDemografi(Tbl_DataKTP_Demografis req)
        {
            try
            {
                ...
                _logger.LogError("[ErrorEnrollmentKTPRepository] : UpdateDemografi : " + ex.Message, ex);
            }
        ...
        public async Task<Tbl_DataKTP_Demografis_Log> InsertDemografiLog(Tbl_DataKTP_Demografis_Log req)
        {
            ...
            "values(" +
                ...
                _logger.LogError("[ErrorEnrollmentKTPRepository] : InsertDemografiLog : " + ex.Message, ex);
            }
        ...
        public async Task<Tbl_Mapping_Pegawai_KTP> InsertMappingPegawaiKTP(Tbl_Mapping_Pegawai_KTP req)
        {
            ...
            {
                _logger.LogError("[ErrorEnrollmentKTPRepository] : " + ex.Message, ex);
            }
        ...
        public async Task<Tbl_Mapping_Pegawai_KTP> UpdateMappingKTP(Tbl_Mapping_Pegawai_KTP req)
        {
            ...
            {
                _logger.LogError("[ErrorEnrollmentKTPRepository] : UpdateMappingKTP : " + ex.Message, ex);
            }
        ...
        public async Task<Tbl_DataKTP_PhotoCam> DeletePhotoCamByNik(Tbl_DataKTP_PhotoCam req)
        {
            const string query = "delete from Tbl_DataKTP_PhotoCam " +
                "Where NIK = @Nik";
        ...
        public async Task<Tbl_DataKTP_Finger> InsertFinger(Tbl_DataKTP_Finger req)
        {
            ...
            {
                _logger.LogError("[ErrorEnrollmentKTPRepository] : InsertFinger : " + ex.Message, ex);
            }
        ...
        public async Task<Tbl_DataKTP_Finger> DeleteFingerByNik(Tbl_DataKTP_Finger req)
        {
            const string query = "delete from Tbl_DataKTP_Finger " +
                "Where Nik = @Nik";
        ...
        public async Task<Tbl_DataKTP_Finger_Log> InsertFingerLog(Tbl_DataKTP_Finger_Log req)
        {
            ...
            {
                _logger.LogError("[ErrorEnrollmentKTPRepository] : InsertFingerLog : " + ex.Message, ex);
            }
        ...
        public async Task<Tbl_DataKTP_Finger_Employee> InsertFingerEmployee(Tbl_DataKTP_Finger_Employee req)
        {
            ...
            {
                _logger.LogError("[ErrorEnrollmentKTPRepository : InsertFingerEmployee] : " + ex.Message, ex);
            }
        ...
        public async Task<Tbl_DataKTP_Finger_Employee> DeleteFingerEmployeeByNIK(Tbl_DataKTP_Finger_Employee req)
        {
            const string query = "delete from Tbl_DataKTP_Finger_Employee " +
                "Where Nik = @Nik";
        ...
        public async Task<Tbl_DataKTP_Finger_Employee_Log> InsertFingerEmployeeLog(Tbl_DataKTP_Finger_Employee_Log req)
        {
            ...
            {
                _logger.LogError("[ErrorEnrollmentKTPRepository : InsertFingerEmployeeLog] : " + ex.Message, ex);
            }
