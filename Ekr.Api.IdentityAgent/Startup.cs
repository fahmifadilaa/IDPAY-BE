using Ekr.Api.IdentityAgent.Middleware;
...
namespace Ekr.Api.IdentityAgent
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c => c.SwaggerDoc("v1.2.0", new OpenApiInfo { Title = "Ekr.Api.IdentityAgent", Version = "v1.2.0" }));
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("v1.2.0/swagger.json", "Ekr.Api.IdentityAgent v1.2.0"));
            }
