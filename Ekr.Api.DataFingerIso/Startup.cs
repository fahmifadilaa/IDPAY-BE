using Ekr.Api.DataFingerIso.Middleware;
...
namespace Ekr.Api.DataFingerIso
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1.2.0", new OpenApiInfo { Title = "Ekr.Api.DataFingerIso", Version = "v1.2.0" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            if (bool.Parse(Configuration.GetSection("IsSwaggerVisible").Value))
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("v1.2.0/swagger.json", "Ekr.Api.DataFingerIso main v1.2.0");
                    c.SwaggerEndpoint("DataFingerIso/swagger/v1.2.0/swagger.json", "Ekr.Api.DataFingerIso subdomain v1.2.0");
                }
                );
            }
